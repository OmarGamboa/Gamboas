...
<title>Talk Stats - DecideNow</title>
</head>
...
<div><br></div>
    ...
    <br>
    <h4 align="left"><a href="myEvents.php">Volver a Mis Eventos</a> | <a href="myTalks.php?e=<?php echo $EventID; ?>" >Mis Charlas</a></h4>
	<h3 align="center">Graficas</h3>
	<div>
		<table style="width:100%">
			<tr>
				<td align="left">
